          ...
          ...new Array(2).fill(0).map((_, index) => (
            <React.Fragment key={index}>
              {props.testimonials.map(({ text, image, name, role }, i) => (
                <div className="p-10 rounded-3xl border border-primary/20 shadow-lg shadow-primary/10 max-w-xs w-full bg-card hover:shadow-primary/20 transition-shadow duration-300" key={i}>
